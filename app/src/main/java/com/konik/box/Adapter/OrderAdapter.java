...
import com.konik.box.Model.OrderModel;
...
public class OrderAdapter  extends RecyclerView.Adapter<OrderAdapter.OrderAdapter_Holder> {
    ...
    @NonNull
    @Override
    public OrderAdapter.OrderAdapter_Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.item_order, parent, false); //connecting to cardview
        return new OrderAdapter.OrderAdapter_Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull OrderAdapter.OrderAdapter_Holder holder, int position) {
