...
import com.konik.box.Model.CartModel;
...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.CartAdapter_Holder> {
    ...
    @NonNull
    @Override
    public CartAdapter.CartAdapter_Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        LayoutInflater mInflater = LayoutInflater.from(mContext);
        view = mInflater.inflate(R.layout.item_pb_cart,parent,false); //connecting to cardview
        return new CartAdapter.CartAdapter_Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull CartAdapter.CartAdapter_Holder holder, int position) {
